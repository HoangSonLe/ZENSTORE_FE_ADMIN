...
export const inputVariants = cva(
    " w-full   bg-background  border-default-300 dark:border-700  px-3 h-9   text-lg  file:border-0 file:bg-transparent file:text-lg file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
    {
        variants: {
            color: {
                default:
            ...
            size: {
                sm: "h-8 text-base read-only:leading-8",
                md: "h-9 text-lg read-only:leading-9",
                lg: "h-10 text-xl read-only:leading-10",
                xl: "h-12 text-2xl read-only:leading-[48px]",
            },
        },
        compoundVariants: [
            {
