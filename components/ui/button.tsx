...
const buttonVariants = cva(
    "inline-flex items-center justify-center rounded-md text-lg font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-0   disabled:opacity-50  whitespace-nowrap disabled:pointer-events-none",
    {
        variants: {
            color: {
            ...
            size: {
                ...
                lg: "h-11 rounded-md px-[18px] py-[10px] text-xl",
                xl: "h-12 rounded-md px-6 py-3 text-2xl",
                md: "h-9 rounded-md px-4 py-2 text-lg",
                xs: "h-9 rounded-md px-[14px] py-[6px] text-base",
                icon: "h-10 w-10",
            },
        },
        compoundVariants: [
