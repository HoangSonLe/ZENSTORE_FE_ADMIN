    ...
    theme: {
        ...
        extend: {
            ...
            fontSize: {
                ...
                sm: ["1.125rem", { lineHeight: "1.625rem" }], // Increased from 1rem
                base: ["1.25rem", { lineHeight: "1.875rem" }], // Increased from 1.125rem
                lg: ["1.375rem", { lineHeight: "2rem" }], // Increased from 1.25rem
                xl: ["1.5rem", { lineHeight: "2rem" }], // Increased from 1.375rem
                "2xl": ["1.75rem", { lineHeight: "2.25rem" }], // Increased from 1.625rem
                "3xl": ["2rem", { lineHeight: "2.5rem" }], // Increased from 1.875rem
                "4xl": ["2.5rem", { lineHeight: "2.75rem" }], // Increased from 2.25rem
                "5xl": ["3.25rem", { lineHeight: "1.1" }], // Increased from 3rem
